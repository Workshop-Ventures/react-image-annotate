...
export var MainLayout = function MainLayout(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(FullScreenContainer, null, /*#__PURE__*/React.createElement(FullScreen, {
    ...
    iconSidebarItems: [{
      ...
      name: "pan",
      helperText: "Drag/Pan (right or middle click)" + getHotkeyHelpText("pan_tool") // alwaysShowing: true,

    }, {
      name: "zoom",
      helperText: "Zoom In/Out (scroll)" + getHotkeyHelpText("zoom_tool") // alwaysShowing: true,
